...
const updateReview = async (req, res) => {
    ...
    await review.save();
    res.status(StatusCodes.OK).json({msg: "review udpated.", review})
...
const deleteReview = async (req, res) => {
    ...
    const reviewUser = review.user.toString();

    checkPermissions(req.user, reviewUser);

    const deletedReview = await review.remove();
    res.status(StatusCodes.OK).json({msg: "review deleted.", deletedReview})
